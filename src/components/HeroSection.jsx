...
function HeroSection() {
  return (
    <section
      id="home"
      className="relative grid place-items-center z-40 mt-[-3.5rem] lg:mt-[-4.6rem] before:absolute before:content[''] before:top-0 before:start-0 before:w-full before:h-full before:bg-black/[0.8] h-dvh bg-[url('/src/assets/hero-section.jpg')] bg-cover bg-no-repeat bg-center"
    >
      <div className="absolute flex flex-col gap-7 md:gap-5 w-3/4 md:1/2 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mx-auto">
          <PrimaryButton text="start now" href="features" />
