...
function HeroSection() {
  return (
    <section className="relative grid place-items-center before:absolute before:content[''] before:top-0 before:start-0 before:w-full before:h-full before:bg-black/[0.8] h-dvh bg-[url('/src/assets/hero-section.jpg')] bg-cover bg-no-repeat bg-center">
